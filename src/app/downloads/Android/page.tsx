...
const DownloadForAndroidPage: FC = () => (
  <>
    <Section
    ...
    >
      <div className="w-full lg:w-2/3 flex flex-col md:items-start gap-6">
        <SectionHeading className="lg:w-2/3 md:text-start mb-0">
          Download GShield VPN for Android
        </SectionHeading>
        ...
        {[
          {
            ...
            description:
              'Visit the Play Store and search for "GShield VPN" or click the download button above.',
            Icon: AndroidIcon,
          },
          {
    ...
    <Section
      heading={
        <>
          <span className="text-primary">GShield VPN</span> Android App
        </>
      }
    >
...
export default DownloadForAndroidPage;
